export default function Header() {
  return (
    <header className="relative z-20 flex items-center justify-between px-6 py-4 bg-white/10 backdrop-blur-sm border-b border-white/20">
      ...
      <div className="flex space-x-4">
        <button className="text-white text-xs font-semibold tracking-widest uppercase px-4 py-2 border border-white rounded-md hover:bg-white/20 transition">
          SING IN
        </button>
        <button className="text-white text-xs font-semibold tracking-widest uppercase px-4 py-2 border border-white rounded-md hover:bg-white/20 transition">
          LOG IN
