...
export default function NewsletterSection() {
  return (
    <section className="max-w-3xl text-center mx-auto w-full mt-16">
      <div className="border-4 rounded-3xl p-8 border-gradient-to-br from-purple-500 via-pink-500 to-cyan-400">
        <h3 className="text-base font-semibold tracking-wide mb-1">SUBSCRIBE TO OUR NEWSLETTER</h3>
        ...
        <form className="flex rounded-full overflow-hidden max-w-md mx-auto border border-purple-600">
          ...
          <button className="bg-gradient-to-r from-cyan-400 to-purple-600 px-5 text-base font-semibold tracking-wide" type="submit">Subscribe</button>
        </form>
      </div>
    </section>
  );
